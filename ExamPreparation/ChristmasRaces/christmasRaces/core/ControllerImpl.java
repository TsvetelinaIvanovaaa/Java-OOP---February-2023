...
public class ControllerImpl implements Controller {
    ...
    public String addDriverToRace(String raceName, String driverName) {
        ...
        return String.format(OutputMessages.DRIVER_ADDED,driver, raceName);
    }
    ...
    public String startRace(String raceName) {
        ...
        //List<Driver> participants = drivers.stream().sorted((d1,d2)-> Double.compare(d2.getCar().calculateRacePoints(numberOfLaps),d2.getCar().calculateRacePoints(numberOfLaps))).limit(3).collect(Collectors.toList());
